...
### 🔀 질문 유형 분류 (5종)
질문은 그대로 LLM에 넘기지 않고, 사전 처리(분류·의도 파악) 단계에서 아래 5가지 유형으로 분기하여 각 유형에 맞는 데이터 소스/체인을 선택하도록 설계하였습니다.

| 유형 | 설명 | 예시 |
|:---|:---|:---|
| **사업정보 질문** | 기업의 사업 관련 질문 | 주력 사업, 신사업, 시장 점유율 등 |
| **재무정보 질문** | 재무제표·지표 관련 질문 | 손익계산서, 재무상태표, 수익성 지표 등 |
| **회계정보 질문** | 회계 해석·기준 관련 질문 | 재무제표 해석 방법, 회계 기준 질문 등 |
| **복합 정보** | 두 가지 이상의 정보를 함께 묻는 질문 | "작년 매출과 무슨 사업을 했는지 알려줘" |
| **그 외 질문** | 기업과 관련 없는 질문 | — |
